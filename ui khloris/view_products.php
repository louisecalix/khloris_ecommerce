<<<<<<< HEAD:ui khloris/view_products.php
<?php
session_start();
    ...
    <div class="info">
      ...
      <table>
        ...
        <tr>
          ...
          <td>
            <a
              href="../admin/update_product.php?id=<?php echo $row['id'] ?>"
              class="update-btn"
              >Update</a
            >
          </td>
          ...
          <td>
            <a
              href="view_products.php?id=<?php echo $row['id'] ?>"
              class="delete-btn"
...
>>>>>>> bc007b6 (ede):ui khloris/view_products.html
