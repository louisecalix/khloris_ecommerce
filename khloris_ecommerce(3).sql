...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 08, 2024 at 10:59 AM
...
CREATE TRIGGER `before_cart_insert` BEFORE INSERT ON `cart` FOR EACH ROW BEGIN
  ...
  SELECT `product_name`, `product_price`, `image_url`
  INTO prod_name, prod_price, prod_image
  FROM `products`
...
(17, 'new', 'new', 'new', 'new'),
(18, 'qq', 'qq', 'qq', 'qq'),
(19, 'bea', 'beicoleene', 'cjcnjrfkrf', '123'),
